    ...
    def __init__(self, token: Optional[str] = None, **kwargs):
        ...
        if token is not None:
            ...
            self.endpoint_lineitem = (
                ...
                and "lineitem" in payload["https://purl.imsglobal.org/spec/lti-ags/claim/endpoint"]
                else ""
            )
            self.endpoint_lineitems = (
                payload["https://purl.imsglobal.org/spec/lti-ags/claim/endpoint"]["lineitems"]
                if "https://purl.imsglobal.org/spec/lti-ags/claim/endpoint" in payload
                and "lineitems" in payload["https://purl.imsglobal.org/spec/lti-ags/claim/endpoint"]
                else ""
            )
            self.scopes = (
                payload["https://purl.imsglobal.org/spec/lti-ags/claim/endpoint"]["scopes"]
                if "https://purl.imsglobal.org/spec/lti-ags/claim/endpoint" in payload
                and "scopes" in payload["https://purl.imsglobal.org/spec/lti-ags/claim/endpoint"]
                else ""
            )
